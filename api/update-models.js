// api/update-models.js
// Called daily by GitHub Actions to refresh LLM pricing.
// Secured by CRON_SECRET header (x-cron-secret).
...
export default async function handler(req, res) {
  ...
  console.log(`[update-models] upserted=${upserted} errors=${errors}`);
