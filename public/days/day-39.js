// Day 39 — Phase 2 Capstone: Competitive Teardown
// Updated: March 2026 | Review: primary research requirement, updated competitive landscape, enhanced teardown template

window.COURSE_DAY_DATA = window.COURSE_DAY_DATA || {};
window.COURSE_DAY_DATA[39] = {
  ...
  tasks: [
    { title: 'Choose your vertical and sign up', description: 'Pick one AI product vertical (code assistants, customer support, document intelligence, or search). Sign up for a free trial or freemium tier of at least one competitor in that space. Spend 30 minutes using the product on a real task. Document: onboarding experience, time to first value, quality of AI output, one failure mode, and one strength. Take screenshots. Save as /day-39/primary_research_notes.md.', time: '35 min' },
    { title: 'Complete the competitive teardown', description: 'Using the enhanced template, write the full competitive teardown for your chosen vertical. Include all five sections: market overview, player analysis (3\u20145 products), strategic comparison with feature matrix, threat assessment across all four layers, and your recommendation. This should be 2,000\u20133,000 words \u2014 detailed enough to present to a VP of Product. Save as /day-39/competitive_teardown.md.', time: '60 min' },
...
`,
  ...
  resources: [
    { type: 'TOOL', title: 'Artificial Analysis', url: 'https://artificialanalysis.ai/', note: 'Model benchmarks and pricing to inform your competitive analysis.' },
    { type: 'TOOL', title: 'Hugging Face', url: 'https://huggingface.co/', note: 'Open-source model landscape for threat assessment layer 4.' },
    { type: 'BLOG', title: 'Latent Space', url: 'https://www.latent.space/', note: 'AI industry analysis to ground your market overview.' },
    { type: 'BLOG', title: 'Sequoia: Generative AI Market Map', url: 'https://www.sequoiacap.com/article/generative-ai-act-two/', note: 'Category landscape and investment thesis.' },
    { type: 'BLOG', title: 'a16z: AI Market Analysis', url: 'https://a16z.com/ai/', note: 'Andreessen Horowitz AI market analysis and frameworks.' }
  ]
};
