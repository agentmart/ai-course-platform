...
console.log("\\nProgression: Start inline → Move to MCP when reuse matters");`
  ...
  resources: [
    { type: 'DOCS', title: 'MCP Specification', url: 'https://spec.modelcontextprotocol.io/', note: 'The official MCP 1.0 specification. Read the architecture overview first.' },
    ...
    { type: 'DOCS', title: 'MCP Authorization (OAuth)', url: 'https://spec.modelcontextprotocol.io/specification/2025-03-26/basic/authorization/', note: 'OAuth 2.0 framework for remote MCP servers. Critical for enterprise.' },
