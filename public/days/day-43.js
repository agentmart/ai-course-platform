// Day 43 — Claude Code (Agentic CLI)
// Updated: March 2026 | Review: GA status, SDK/API access, GitHub Actions, sub-agents, MCP integration, CLAUDE.md best practices, vibe-coding

window.COURSE_DAY_DATA = window.COURSE_DAY_DATA || {};
window.COURSE_DAY_DATA[43] = {
  ...
  tasks: [
    { title: 'Write a CLAUDE.md for a real project', description: 'Choose a project you\u2019re working on (or use a sample project). Write a complete CLAUDE.md following best practices: architecture overview (2\u20133 paragraphs), coding conventions (style, naming, patterns), testing requirements (what\u2019s expected for new code), and a \u201cnever do\u201d list of anti-patterns. Test it by having Claude Code use it \u2014 does it improve output quality? Save as /day-43/claude_md_template.md.', time: '25 min' },
    { title: 'Design a CI/CD pipeline with Claude Code', description: 'Design a GitHub Actions workflow that integrates Claude Code for: automated PR review (code quality, security scan), automated test generation for new code, and automated documentation updates. Specify: trigger conditions, permissions model (what should Claude Code be allowed to do?), failure handling, and human approval gates. Save as /day-43/cicd_claude_code.md.', time: '25 min' },
...
`,
  ...
  resources: [
    { type: 'DOCS', title: 'Claude Code Documentation', url: 'https://docs.anthropic.com/en/docs/claude-code', note: 'Official documentation for Claude Code GA features.' },
