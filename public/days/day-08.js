...
window.COURSE_DAY_DATA[8] = {
  ...
  <p><strong>Inference cost trajectory:</strong> The course\u2019s original claim that "inference costs are sticky" was wrong. Inference costs have fallen dramatically faster than predicted, driven by hardware improvements (custom silicon like Google TPUs and Amazon Trainium), software optimizations (FlashAttention, speculative decoding, KV-cache compression), and model efficiency techniques (distillation, quantization). GPT-4-level capability that cost $120/1M tokens in 2023 costs under $1/1M on equivalent-class models in 2025. This trajectory matters for product strategy: features that were too expensive to ship 18 months ago may now be economically viable.</p>
